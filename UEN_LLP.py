...
with open(output_file_name+'.csv','wb') as file:
    for i in range(start_uen,end_number):
        ...
        digits_value=(18*15)+(start_year1[2]*14)+(start_year1[3]*5)+(11*14)+(11*21)+(digits[0]*13)+(digits[1]*2)+(digits[2]*5)+(digits[3]*18)
        ...
        if alpha_value==24:
            alpha_letter="Z"
        registration_number='T'+str(start_year1[2])+str(start_year1[3])+'LL'+str(start_series)+alpha_letter
